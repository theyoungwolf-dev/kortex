...
const (
	// Label holds the string label denoting the dynosession type in the database.
	Label = "dyno_session"
	...
	CarTable = "dyno_sessions"
	// CarInverseTable is the table name for the Car entity.
	// It exists in this package in order to avoid circular dependency with the "car" package.
	CarInverseTable = "cars"
	// CarColumn is the table column denoting the car relation/edge.
	CarColumn = "car_dyno_sessions"
	// ResultsTable is the table that holds the results relation/edge.
	ResultsTable = "dyno_results"
	// ResultsInverseTable is the table name for the DynoResult entity.
	// It exists in this package in order to avoid circular dependency with the "dynoresult" package.
	ResultsInverseTable = "dyno_results"
	// ResultsColumn is the table column denoting the results relation/edge.
	ResultsColumn = "dyno_session_results"
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "dyno_sessions"
...
// OrderOption defines the ordering options for the DynoSession queries.
