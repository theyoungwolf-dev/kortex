...
summary: "See how I leveraged Go, GQLGen, Ent, and Uber FX to build Kortex 1 fast, securely, and with minimal boilerplate—so I can focus on features that matter."
---

For Kortex 1, my app for car enthusiasts and DIY mechanics, I needed to build quickly without sacrificing performance, security, or maintainability. Go provides the solid foundation, but pairing it with GQLGen, Ent, and Uber FX delivers real development velocity.
...
```sh
go mod init github.com/theyoungwolf-dev/kortex
```
...
To sum up, leveraging Ent to handle the heavy lifting of CRUD operations, combining it with GQLGen for a fully type-safe GraphQL API, and using Uber FX for lifecycle management and dependency injection allowed me to build Kortex 1 quickly and reliably.
